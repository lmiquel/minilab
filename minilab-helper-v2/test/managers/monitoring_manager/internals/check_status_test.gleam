import commons/types/container_status.{ContainerStatus}
import commons/types/health_status.{Healthy, NoHealthcheck, Starting, Unhealthy}
import dictionaries/docker_services_dictionary/types/service_name.{
  Cloudflared, Valheim,
}
import managers/monitoring_manager/internals/check_status.{check_status}
import managers/monitoring_manager/types/service_state.{ServiceState}
